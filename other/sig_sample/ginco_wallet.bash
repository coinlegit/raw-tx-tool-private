...
#master_seed=$( echo -n ${master_seed} | bx hd-new )  
#master_seed=''
#master_seed=$( echo -n ${master_seed} | bx hd-new -v 76066276 )  
...
# m/44'/145'/0'
echo -n "m/44'/145'/0'#[xprv]':    " & echo ${master_seed}  | bx hd-private -d -i 44 | bx hd-private -d -i 145 | bx hd-private -d -i 0 
echo -n "m/44'/145'/0'#[xpub]':    " & echo ${master_seed}  | bx hd-private -d -i 44 | bx hd-private -d -i 145 | bx hd-private -d -i 0 | bx hd-to-public 
...
#0,111
echo -n "m/44'/145'/0'/0/${i}    :  " && echo ${xpub} | bx hd-to-ec | bx ec-to-address -v 0
done
